...
Usage:
    python screening/score.py --rubric screening/rubrics/example-ops-generalist-role.json \\
        --records screening/examples/candidates.json [--out shortlist.json] [--model anthropic]
"""
