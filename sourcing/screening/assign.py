...
construction). Exit code 1 if any slack was used, so a wrapper can stop and ask.
    ...
    python sourcing/screening/assign.py --demo             # 40 fictional items, 12 fictional reviewers
    python sourcing/screening/assign.py --reviewers r.json --items i.json [--out assignments.json]
"""
